...
class AlignDlib:
    ...
    def __init__(self):
        ...
        """
        facePredictor = './akshi/face/bin/shape_predictor_68_face_landmarks.dat'
    ...
    def align(self, imgDim, rgbImg, bb=None,
        ...
        prod1 = np.float32(imgDim * MINMAX_TEMPLATE[npLandmarkIndices])

        # pylint: disable=maybe-no-member
        #H = cv2.getAffineTransform(npLandmarks[npLandmarkIndices],
         #                          imgDim * MINMAX_TEMPLATE[npLandmarkIndices] * scale + imgDim * (1 - scale) / 2)

        H = cv2.getAffineTransform(npLandmarks[npLandmarkIndices], prod1)
        thumbnail = cv2.warpAffine(rgbImg, H, imgDim)
